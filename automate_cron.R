...
cmd <- cronR::cron_rscript(rscript = file.path(home_dir, "download_grid.R"),
                           ...
                           trailing_arg = "curl -fsS -m 10 --retry 5 -o /dev/null https://hc-ping.com/019f9231-6c9f-4ef8-a18d-b34e339bfafb")
...
cmd <- cronR::cron_rscript(rscript = file.path(home_dir, "process_grid.R"),
                           ...
                           log_append = FALSE,
                           workdir = file.path(home_dir),
                           trailing_arg = "curl -fsS -m 10 --retry 5 -o /dev/null https://hc-ping.com/d5eea4f0-fe44-4dd8-bc00-1082e1bb7d93")
